...
# id = 'state_city_zip'
id = 'state_city'
no_change_columns = ['city', 'my_zip', 'url', id]

# all dates for selecting best estimates
# read the new csv here
# df = pd.read_csv('data/test-zip.csv')
...
# old = pd.read_pickle('data/final_database_frames/zip_v3.pkl')
...
# updated_new.to_pickle('data/final_database_frames/db_2019_9_01_v1_zip.pkl')
